        ...
        window.paypal.Buttons({
            ...
            createOrder: async (data, actions) => {
                ...
                try {
                    ...
                    Swal.fire("Erreur", "Impossible d'initialiser le paiement.", "error");
                }
            },
            ...
            onApprove: async (data, actions) => {
                try {
                    ...
                    if (response.ok) {
                        Swal.fire("Succès", `Rechargement réussi ! Nouveau solde : ${transactionData.newBalance}€`, "success");
                        ...
                        Swal.fire("Erreur", "Le paiement n'a pas pu être validé.", "error");
                    }
                } catch (error) {
                    console.error("Erreur captureOrder:", error);
                    Swal.fire("Erreur", "Erreur réseau lors de la validation.", "error");
                }
            }
        }).render(`#${containerId}`);
    }
